...
const LANDMARKS := [
	...
	{"name": "Everest summit +3 km", "body": "Earth", "mode": "surface",
		...
		"note": "3 km above the restored summit (8848 m); looking south"},
	{"name": "Everest from the south +4 km", "body": "Earth", "mode": "surface",
		"lat_deg": 27.82, "lon_deg": 86.925, "alt_km": 4.0, "heading_deg": 0.0,
		"note": "looking north at the 8848 m pyramid"},
	...
	{"name": "Amazon canopy 300 m", "body": "Earth", "mode": "surface",
		"lat_deg": -3.0, "lon_deg": -60.0, "alt_km": 0.3, "heading_deg": 0.0,
		"note": "real-scale forest canopy — kit prop review"},
