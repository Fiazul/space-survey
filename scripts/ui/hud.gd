...
const GUIDE := [
	...
	["WORMHOLES",
	 "Glowing rings are wormholes to neighbouring systems. Fly close and press F to dive through — a dark tunnel carries you across the light-years (longer hops take longer). Known lanes show on the 3D map (M, Tab local/global) and the corner radar; the network links every system within a few hops of home."],
	["TELEPORT  (H)",
